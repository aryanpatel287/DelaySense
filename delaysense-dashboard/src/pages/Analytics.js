    ...
    <div className="min-h-screen bg-[#f8fafb] flex flex-col items-center py-10 px-2">
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="flex gap-8 border-b border-gray-200 mb-8">
          <button className="pb-2 border-b-2 font-semibold" style={{ color: THEME_BLUE, borderColor: THEME_BLUE }}>Overview</button>
          <button className="pb-2 text-gray-400 font-semibold">Details</button>
          <button className="pb-2 text-gray-400 font-semibold">Actions</button>
        </div>
